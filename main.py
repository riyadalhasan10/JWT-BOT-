...
ADMIN_ID = 7603719412 # Default to 0 (disabled) if not set or invalid
# Check and warn if ADMIN_ID is 0 but commands are expected
if ADMIN_ID == 7603719412:
...
ADMIN_CONTACT_LINK = os.getenv('ADMIN_CONTACT_LINK', 'https://t.me/riyadalhasan11') # Default admin contact link
